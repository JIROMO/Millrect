...
var HELP_INDEX = [
  ...
  },
  {
    ...
    summary: "キャンバスやレイヤー一覧での選択・複数選択・移動",
  },
  {
    title: "プロパティ領域",
    section: "編集操作",
  ...
  },
  {
    ...
    summary: "元図形を残して指定距離の内側・外側輪郭を作成",
  },
  {
    title: "重なり順",
    section: "編集操作",
...
var HELP_INDEX_EN = {
  ...
  "editing.html#select": {
    ...
    summary: "Select and move shapes on canvas or from the Layers list",
  },
  "editing.html#design": {
  ...
  "editing.html#offset": {
    title: "Inside and outside offset",
    section: "Editing",
    keywords: [
      "offset",
      "inside",
    ...
    summary: "Keep the original and create an inward or outward outline",
  },
  "editing.html#z-order": {
    ...
    summary: "Move overlapping shapes forward or backward",
  },
  "editing.html#group": {
    title: "Grouping",
    section: "Editing",
  ...
  "multiview-3d.html#revolved-shapes": {
    title: "Cones and conical frustums",
    section: "3D generation",
    keywords: [
      "cone",
      "cylinder",
    ...
    summary: "Generate a revolved shape from a top circle and front profile",
  },
