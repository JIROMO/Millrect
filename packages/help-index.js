...
var HELP_INDEX = [
    ...
    },
    {
        ...
        summary: "寸法を変えると 2D 図面・寸法アイソメ図・Part DSL が更新される作例",
    },
    {
        title: "画像運用",
        section: "設計標本帳",
    ...
    },
    {
        ...
        summary: "レイヤー・ページ・プロパティ・履歴タブ。Pages 内に参照画像、フォント、制作メモ",
    },
    {
        ...
        summary: "Pages タブ内 — フォントを探す / ライブラリ / プロジェクトへの追加",
    },
    {
        title: "制作メモ（Pages タブ）",
        section: "画面構成",
        ...
        summary: "Pages タブ内 — projectBrief の意図・フェーズ・設計原則・判断履歴を確認",
    },
    {
        title: "3D プレビューパネル",
        section: "画面構成",
    ...
    },
    {
        ...
        summary: "図面上に文字を配置。同梱フォントとプロジェクト登録フォントから選択",
    },
    {
        ...
        summary: "Fontsource から Google Fonts を検索登録。ライブラリでプロジェクト横断再利用（PC フォントではない）",
    },
    {
        title: "テキストのアウトライン化",
        section: "2D 描画",
...
var HELP_INDEX_EN = {
    ...
    "index.html#capabilities": {
        ...
        summary: "Overview of drawing, 3D, sketch import, AI integration, and Taste Memory",
    },
    "atlas.html": {
        title: "Design Atlas",
        section: "Guide",
        ...
        summary: "Explore drawings, 3D, AI/MCP, and Part DSL from reusable design specimens",
    },
    "atlas.html#live-specimen": {
        title: "Live Specimen",
        section: "Design Atlas",
        keywords: ["live", "parameter", "dimension", "hole", "DSL", "interactive"],
        summary: "Change dimensions and update the 2D drawing, dimensioned isometric, and Part DSL together",
    },
    "atlas.html#image-system": {
        title: "Image system",
        section: "Design Atlas",
        keywords: ["screenshot", "image", "capture", "scenario", "maintenance"],
        summary: "Manage screenshots as Showcase, Scenario capture, and UI proof images",
    },
    "philosophy.html": {
        title: "Philosophy",
        section: "Guide",
        keywords: ["philosophy", "drawing", "3D", "AI", "MCP", "export"],
        summary: "Why Millrect treats drawings as primary and 3D, AI, and export as supporting layers",
    },
    ...
    "interface.html#right-panel": {
        ...
        summary: "Layers, pages, properties, history, reference images, project fonts, and Taste brief",
    },
    ...
    "interface.html#taste-brief-panel": {
        ...
        summary: "Pages tab — inspect projectBrief intent, phase, design principles, and decisions",
    },
    ...
    "drawing.html#canvas-images": {
        ...
        summary: "Place images as normal objects; move, resize, save, and export them",
    },
    "drawing.html#layers": {
    ...
    "drawing.html#sketch-import": {
        ...
        summary: "Reference underlay, move/resize, scale calibration, ghost confirm",
    },
    ...
    "drawing.html#transform": {
        ...
        summary: "Rotation and flip are reflected in display, alignment, Profile, and 3D",
    },
    "editing.html": {
        title: "Editing",
        section: "Guide",
    ...
    "ai-mcp.html#taste-memory": {
        ...
        summary: "Record intent, constraints, preferences, design decisions, and review history",
    },
...
function searchHelpIndex(query, limit, locale) {
    limit = limit || 12;
    locale = normalizeHelpLocale(locale !== undefined ? locale : getHelpSearchLocale());
    ...
    for (var i = 0; i < HELP_INDEX.length; i++) {
        ...
        for (var t = 0; t < tokens.length; t++) {
            var token = tokens[t];
            if (entry.title.toLowerCase().indexOf(token) >= 0)
                score += 12;
            if (entry.keywords.some(function (k) {
                return k.toLowerCase().indexOf(token) >= 0;
            }))
                score += 8;
            if (entry.section.toLowerCase().indexOf(token) >= 0)
                score += 4;
