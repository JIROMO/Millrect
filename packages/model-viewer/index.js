...
(function initModelViewer(root, factory) {
...
})(typeof globalThis !== "undefined" ? globalThis : null, function factory(THREE) {
    function createGeometry(meshData, materialOverride) {
        ...
        return new THREE.Mesh(geometry, materialOverride ||
    ...
    function createModelViewer(canvas, options = {}) {
        if (!THREE)
            throw new Error("Three.js is required for model-viewer");
