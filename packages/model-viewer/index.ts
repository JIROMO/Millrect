...
(function initModelViewer(root: any, factory: (THREE: any) => any) {
  ...
  function factory(THREE: any) {
    function createGeometry(meshData: any, materialOverride?: any): any {
    ...
    function createModelViewer(canvas: any, options: any = {}): any {
      ...
      function setGeometryData(data: any) {
        clear();
