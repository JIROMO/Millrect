...
function findBundledFontFile(family: any, style = "Regular"): string | null {
...
function getFontSearchDirs(platform: string = process.platform): string[] {
  if (platform === "darwin") {
    return [
...
function findFontFile(
  ...
  const candidates: { full: string; score: number }[] = [];
...
export { getFontSearchDirs, findFontFile, findBundledFontFile, readFontFile };
