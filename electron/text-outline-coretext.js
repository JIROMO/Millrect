...
exports.outlineTextCoreText = outlineTextCoreText;
exports.isCoreTextOutlineAvailable = isCoreTextOutlineAvailable;
exports.getCoreTextBinaryPath = getCoreTextBinaryPath;
...
function getCoreTextBinaryPath() {
    ...
    return path.join(__dirname, "..", "native", "macos", "outline-text", "bin", binName);
}
