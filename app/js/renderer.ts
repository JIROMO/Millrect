...
if (typeof window !== "undefined") {
  Object.assign(window, {
    ...
    textShapeLineHeight,
    textShapeInkColor,
    applyTextShapeElementStyle,
    measureTextLayoutDom,
    measureTextLayout,
    measureTextOutlineMetricsDom,
    measureTextOutlineMetrics,
    textHasFixedWidth,
    getTextLayoutBoxPaper,
    computeTextRealWidth,
    textPaperWidth,
    render,
    _isPrintRenderMode,
    _doRender,
    ...
    renderReferenceImageEditOverlay,
    renderReferenceScaleAnchorOverlay,
    renderGrid,
    renderShapes,
    renderShape,
    getShapeLocalPivotPaper,
    getGroupLocalPivotPaper,
    getShapeBBox,
    _getShapeBBoxLegacy,
    formatMmBadge,
    appendSelectionSizeBadge,
