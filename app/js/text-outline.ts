...
if (typeof window !== "undefined") {
  Object.assign(window, {
    isTextOutlineAvailable,
    isTextNativePreviewEnabled,
    shouldShowTextForeignObject,
    isTextNativeLayoutEnabled,
    _invokeMeasureTextLayout,
    _invokeOutlineText,
    _parsePreviewKey,
    _scaleOutlineChildrenFromAnchor,
    _previewChildrenLiveTransform,
    _layoutMetricsLiveTransform,
    isTextNativeLiveTransform,
    setTextNativeLiveTransform,
    _colorizePreviewChildren,
    _contourGrouping,
    _flattenContourRings,
    _groupContourRings,
    _flattenToSingleRingPolys,
    _unionGlyphContours,
    _prepareGlyphOutlineChild,
    _outlineChildHasArea,
    _projectFontFilesForPayload,
    _textPreviewKey,
    _translateOutlineChildrenXY,
    _previewChildrenForShape,
    _textNeedsCjk,
    _fontCandidatesForOutline,
    textNativePreviewBBoxPaper,
    _outlineChildrenBBoxPaper,
    _alignOutlineChildrenVertically,
    _buildLayoutPayload,
    _buildOutlinePayload,
    _fetchOutlineChildren,
    invalidateTextNativePreview,
    getTextNativeLayoutMetrics,
    scheduleTextNativeLayout,
    refreshTextNativeLayout,
    refreshAllTextNativeLayouts,
    getTextNativePreviewChildren,
    scheduleTextNativePreview,
    refreshTextNativePreview,
    refreshAllTextNativePreviews,
    onTextShapeDocumentChanged,
    outlineTextShape,
    _textPreviewCache,
    _textPreviewTimers,
    _textPreviewFailures,
    _textLayoutCache,
    _textLayoutTimers,
    _textLiveTransformIds,
  });
}
